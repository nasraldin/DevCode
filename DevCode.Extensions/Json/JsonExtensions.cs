...
namespace DevCode.Extensions.Json
{
    ...
    {
        private static readonly CamelCasePropNamesContractResolver SharedCamelCasePropertyNamesContractResolver;
        private static readonly ContractResolver SharedAbpContractResolver;

        static JsonExtensions()
        {
            SharedCamelCasePropertyNamesContractResolver = new CamelCasePropNamesContractResolver();
            SharedAbpContractResolver = new ContractResolver();
        }
        ...
        public static string ToJsonString(this object obj, bool camelCase = false, bool indented = false)
        {
            ...
            if (camelCase)
            {
                settings.ContractResolver = SharedCamelCasePropertyNamesContractResolver;
            }
            else
            {
