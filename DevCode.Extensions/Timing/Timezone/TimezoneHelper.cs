using DevCode.Extensions.IO;
using DevCode.Extensions.Reflection;
using DevCode.Extensions.Xml;
using System;
...
namespace DevCode.Extensions.Timing.Timezone
{
    /// <summary>
    ...
    public static class TimezoneHelper
    {
        ...
        private static DateTime NthOf(this DateTime currentDate, int occurrence, DayOfWeek day)
        {
            ...
            if (firstOccurrence.Month < currentDate.Month) occurrence += 1;
